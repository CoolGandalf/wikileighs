...
export function App() {
  ...
  if (route === "agents") return <DirectoryPage key="agents" active="agents" kicker="THE HERMES / CLAUDE CABINET · LIVE MAC AUDIT" title="Agent roster" accent="#ff6b4a" description="The live Hermes cabinet, on-demand specialists, personal agents, and the historical LifeOS patterns they replaced or absorbed." items={agents} statLabel="agents documented" note="Reconciled against the live MacBook Hermes gateway, profiles, topics, cron jobs, and Emrys registry" />;
